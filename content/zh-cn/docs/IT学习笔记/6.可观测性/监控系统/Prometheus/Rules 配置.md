...
interval 字段的值 加上 PrometheusServer 的命令行标志 --rules.alert.resend-delay 的值(默认 1m)，才是真实的评估周期。这个说明在官方文档中没有，请参考[源码解析](✏IT 学习笔记/👀6.可观测性/监控系统/Prometheus/Prometheus%20 开发/Prometheus%20 规则处理逻辑.md 开发/Prometheus 规则处理逻辑.md)
