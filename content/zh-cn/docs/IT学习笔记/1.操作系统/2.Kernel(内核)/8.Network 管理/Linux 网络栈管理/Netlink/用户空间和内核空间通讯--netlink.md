...
struct sk_buff { /* These two members must be first. _/ struct sk_buff *next; struct sk_buff *prev; … … /\*_ This is the control buffer. It is free to use for every _layer. Please put your private variables there. If you_ want to keep them across layers you have to do a skb*clone()* first. This is owned by whoever has the skb queued ATM. _/ char cb\[48]; … … }
