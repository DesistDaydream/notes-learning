...
> 参考：[原文](https://jouyouyun.github.io/post/linux_hardware_info/)
...
```bash
[root@host-3 ~]# ls -l /sys/class/dmi/id/bios_*
...
```bash
[root@host-3 ~]# ls -l /sys/class/dmi/id/board_*
...
```bash
[root@host-3 ~]# ls -l /sys/class/dmi/id/product_*
...
```bash
[root@host-3 ~]# cat /proc/cpuinfo|grep 'model name'
