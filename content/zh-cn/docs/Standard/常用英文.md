...
- 发 /s/ 音
    - 当字母 c 位于词首或词中时
        - 如果后跟元音字母 y，没有例外
    - 当字母 c 的后面只有一个元音字母，它或者是 e 或者是 i，再之后就是辅音字母或者什么都没有了（也就是单词结束了）。
...
https://github.com/hcfyapp 划词翻译。好像没开源？

[沉浸式翻译](https://chromewebstore.google.com/detail/immersive-translate-ai-we/bpoadfkcbjbfhfodiogcnhhhpibjhbnh) # 商业化公司
...
| 十       | 万                | 千万              | 百亿              | 十万亿          |             |
| ten     | ten thousand     | ten million     | ten billion     | ten trillion |             |
| 百       | 十万               | 亿               | 千亿              |              |             |
| hundred | hundred thousand | hundred million | hundred billion |              |             |

为什么千的缩写不是 t 而是 k ？ https://zhuanlan.zhihu.com/p/610337965

如果我们将其简写为 **1t**，就会出现概念模糊的现象，因为还有一个计量单位 **ton(吨)** 的简写就是 **t**，因此，我们将表示千克**kilo**中的**K**作为简写**千**的单位，当我们说**1000**的时候，可以简写成**1K**。
...
- state 是一个静态的定义性词语。e.g. 你的体重身体状态：偏瘦、偏胖
- status 描述一个对象从一个状态转变为另一个状态的状态变化过程。e.g. 你现在正处在奔跑的状态，一会停下来了就会处在站立不动的状态
