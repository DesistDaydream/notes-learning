...
> 参考：
> - [公众号，小林 coding-我做了个实验！](https://mp.weixin.qq.com/s/HXRGr90baCvM-NQbPIgn-g)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849113737-98d13bdb-f9e9-46a7-85e9-4e6a93a3d879.png)

方式二通过 mmap() 系统调用中「私有匿名映射」的方式，在文件映射区分配一块内存，也就是从文件映射区“偷”了一块内存。如下图：

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849113729-809ce535-f2eb-4103-8095-597a2d986d50.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849113760-5d095529-0f4a-4f12-8acd-61c5cd7603cb.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849113734-9725eecf-f87c-4a53-8e13-440a400091c9.png)

从下图可以看到，通过 free 释放内存后，堆内存还是存在的，并没有归还给操作系统。

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849113802-9898e5ce-9d7b-4b98-aae1-597399246638.png)
...
执行代码：
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849114274-0f6c3f2a-07aa-4e7f-97a6-092f7f35025b.png)
查看进程的内存的分布情况，可以发现最右边没有 \[head] 标志，说明是通过 mmap 以匿名映射的方式从文件映射区分配的匿名内存。
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849114342-227882ac-b9dd-482a-a6f0-4ba35996220b.png)

然后我们释放掉这个内存看看：

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849114378-959f166b-9323-4490-a4f3-39c0c3207f7e.png)

再次查看该 128 KB 内存的起始地址，可以发现已经不存在了，说明归还给了操作系统。

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849114444-e2d4c129-03e2-4fe2-a1a9-37180ca0908e.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849114533-92d5ebc1-a301-40f1-be2a-bdde99d27696.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/qcafxw/1647849114916-d9935c19-fc65-4487-805c-eee1912d50a9.png)
