...
PCI 设备的资源数据以文件形式保存，*PCI 设备资源目录* 通常包含如下文件
...
**`/sys/devices/pci${DOMAIN:BUS}/${DOMAIN:BUS:SLOT.FUNC}/`** # PCI device resouorces(PCI 设备资源) 目录。详见上文 [PCI 设备资源目录](#PCI%20设备资源目录)。包含该 PCI 设备的各种信息，e.g. 供应商、PCI 类型、etc.
