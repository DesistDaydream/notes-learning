...
> [!Tip] --set, --name, --rcheck, --seconds, --hitcount 都是 recent 扩展中可用的选项。详见 [iptables CLI](/docs/1.操作系统/Kernel/Network/Linux%20网络流量控制/Netfilter/Iptables/iptables%20CLI.md)
