...
> - 包含在 [Coreutils](/docs/1.操作系统/X.Linux%20管理/Linux%20管理.md#Coreutils)工具集
...
- **-l** # 输出更多的信息。每列信息所代表的含义详见 《[文件管理](/docs/1.操作系统/2.Kernel(内核)/6.File%20System%20管理/文件管理/文件管理.md)》章节
