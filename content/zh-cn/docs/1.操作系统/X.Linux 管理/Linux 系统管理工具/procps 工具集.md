...
procps 是一组命令行和全屏实用程序，它们主要从 [Proc 文件系统](/docs/1.操作系统/2.Kernel/6.Filesystem/特殊文件系统/Proc%20File%20System.md) 中获取信心，该文件系统为内核数据结构提供了一个简单的接口。procps 程序通常集中在描述系统上运行的进程的结构上。包括以下程序(每个标题都是一个程序)
...
可用的信号详见 [Signal(信号)](/docs/1.操作系统/2.Kernel/7.Process/Inter%20Process%20Communication(进程间通信)/Signal(信号).md)
...
[sysstat 工具集](/docs/1.操作系统/X.Linux%20管理/Linux%20系统管理工具/sysstat%20工具集.md)
