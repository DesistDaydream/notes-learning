...
![https://arthurchiao.art/assets/img/nat-traversal/nat-intro.png|center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-intro.png)
...
![https://arthurchiao.art/assets/img/nat-traversal/nat-firewalls-1a.png|center|700](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-firewalls-1a.png)
...
![https://arthurchiao.art/assets/img/nat-traversal/nat-firewalls-2.png|center](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-firewalls-2.png)
...
![https://arthurchiao.art/assets/img/nat-traversal/nat-firewalls-3.png|center](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-firewalls-3.png)
...
![https://arthurchiao.art/assets/img/nat-traversal/nat-firewalls-4.png|center](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-firewalls-4.png)
...
![https://arthurchiao.art/assets/img/nat-traversal/nat-firewalls-5c.png|center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-firewalls-5c.png)
...
- 在它 **==自己的公网 IP 上挑一个可用的 UDP 端口==** ，例如 `2.2.2.2:4242` ，
...
![https://arthurchiao.art/assets/img/nat-traversal/nat-overview-2.png|center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-overview-2.png)

3. 反向路径是类似的，路由器会执行相反的地址转换，将 `2.2.2.2:4242` 变回 `192.168.0.20:1234` 。对于笔记本来说，它根本感知不知道这正反两次变换过程。

这里是拿家用路由器作为例子，但 **==办公网的原理是一样的==** 。不同之处在于，办公网的 NAT 可能有多台设备组成（高可用、容量等目的），而且它们有不止一个公网 IP 地址可用，因此在选择可用的公网 `ip:port` 来做映射时，选择空间更大，能支持 更多客户端。

![https://arthurchiao.art/assets/img/nat-traversal/nat-overview-3.png|center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat/nat-overview-3.png)

## 3.5 SNAT 给穿透带来的挑战

现在我们遇到了与前面有状态防火墙类似的情况，但这次是 NAT 设备： **==通信双方 不知道对方的 ip:port 是什么==** ，因此 **==无法主动建连==** ，如下图所示：

![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-stun-1.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-stun-2.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-birthday-attack-1.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-birthday-attack-2.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-multiple-layers.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-cgnat-1.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-cgnat-2.png)
...
![center|1000](https://notes-learning.oss-cn-beijing.aliyuncs.com/nat-traversal/nat-ipv6.png)
...
[« \[译\] 写给工程师：关于证书（certificate）和公钥基础设施（PKI）的一切（SmallStep, 2018）](https://arthurchiao.art/blog/everything-about-pki-zh/) [\[译\] \[论文\] 可虚拟化第三代（计算机）架构的规范化条件（ACM, 1974） »](https://arthurchiao.art/blog/formal-requirements-for-virtualizable-arch-zh/)