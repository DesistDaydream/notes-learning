...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079316-312e475f-cb69-45af-8289-7931f6ba39fa.png)

那么对于底数为 2 的时候， 32 的对数是 5，64 的对数是 6，计算过程如下：

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079333-e70a9a79-3367-4ab3-b41f-87d78ba1f188.png)

对数运算的取值是可以连续的，而离散对数的取值是不能连续的，因此也以「离散」得名，

离散对数是在对数运算的基础上加了「模运算」，也就说取余数，对应编程语言的操作符是「%」，也可以用 mod 表示。离散对数的概念如下图：

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079336-e6d23927-9889-4040-ba45-a7c468d0e9b4.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079410-0f5ff362-59ad-4930-8c5b-702e0ec61916.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079396-cb3c352a-51fd-4666-8b40-06b3abfb18b1.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079363-01339e83-2b01-4b86-a51f-158604aec01c.png)

TLS 第二次握手

服务端收到客户端的「打招呼」，同样也要回礼，会返回「**Server Hello**」消息，消息面有服务器确认的 TLS 版本号，也给出了一个**随机数（\*\*\***Server Random**\***）\*\*，然后从客户端的密码套件列表选择了一个合适的密码套件。

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079346-2d236807-70d0-4ab9-8435-d9d1fd616d48.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079339-c3c5361d-6e16-442d-9689-5e0bcd8c3dd4.png)

这一步就和 RSA 握手过程有很大到区别了，因为服务端选择了 ECDHE 密钥协商算法，所以会在发送完证书后，发送「**Server Key Exchange**」消息。

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079354-28ca02df-58e1-4973-98ca-9ebf05385b3d.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079353-e59ab88d-3cc9-4318-8c16-dc534d248e0a.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079379-454c2d83-0d99-432c-a365-ec9d421264c6.png)
...
![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079357-dace13e4-767a-4e9f-8065-088d25cb9e87.png)

接着，客户端会发「**Encrypted Handshake Message**」消息，把之前发送的数据做一个摘要，再用对称密钥加密一下，让服务端做个验证，验证下本次生成的对称密钥是否可以正常使用。

![](https://notes-learning.oss-cn-beijing.aliyuncs.com/dcp3g1/1616161079349-ca3ffe7c-cf01-4e7c-8fc8-c9a966c7ce85.png)
