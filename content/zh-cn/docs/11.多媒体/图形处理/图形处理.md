...
[GitHub 项目，oxipng/oxipng](https://github.com/oxipng/oxipng) # 无损 PNG/APNG 压缩，多线程。

[GitHub 项目，kornelski/pngquant](https://github.com/kornelski/pngquant) # 有损 PNG 压缩。

- 这项目找 Release 好费劲，还得用 Rust 的 cargo install。在[官网](https://pngquant.org/) 的 Download 章节倒是可以直接下载压缩包，但是 Windows 没有 3.0+ 版本的。

https://tinypng.com/ # 在线工具

 https://nikkhokkho.sourceforge.io/?page=FileOptimizer # GUI 的，集成了一堆工具，还能处理其它类型文件的压缩。
