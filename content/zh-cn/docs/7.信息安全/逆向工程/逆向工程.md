...
- 若是静态的数据，在 “[开发者工具](/docs/Web/浏览器/开发者工具.md) - 网络 - 文档” 中查看数据资源
...
- 若是动态的数据，在 “[开发者工具](/docs/Web/浏览器/开发者工具.md) - 网络 - Fetch/XHR” 中查看数据资源
...
- 从网络标签中找到被选中（深灰色北京）的请求，点击该请求的 `启动器` 进入到代码位置
- 使用左下角的 *美观输出*，随后在代码中寻找感兴趣的内容。比如 sign 之类的关键字，找到 sign 的生成逻辑。
