...
https://github.com/BlackINT3/OpenArk # 一款 Windows 平台上的开源Ark工具. Ark 是 Anti-Rootkit（对抗恶意程序）的简写, OpenArk 目标成为逆向工程师、编程人员的工具，同时也能为那些希望清理恶意软件的用户服务。
...
在 [Software design](/docs/2.编程/Programming%20technology/Software%20design.md) 可以知道网站的数据有动态和静态两种。
...
- https://github.com/lasawang/js-sandbox-env-framework # JS补环境框架
...
Jadx 是一个 Dex 到 Java 反编译器。用于从 Android Dex 和 Apk 文件，生成 Java 源代码的 CLI 和 GUI 工具
