...
Delve 是一个用于 [Go](/docs/2.编程/高级编程语言/Go/Go.md) 编程语言的[调试器](/docs/2.编程/Programming%20tools/Debugger.md)。该项目的目标是为 Go 提供一个简单、功能完整的调试工具。Delve 应该易于调用和使用。如果你正在使用调试器，很可能事情进展不顺利。考虑到这一点，Delve 应该尽可能地不妨碍你的工作。
