...
Ultralytics YOLO 的 检测、分段、姿势 模型在 [COCO](/docs/12.AI/Machine%20learning/Dataset.md#COCO) 数据集上预训练，而 分类 模型在 [ImageNet](/docs/12.AI/Machine%20learning/Dataset.md#ImageNet) 数据集上预训练。
