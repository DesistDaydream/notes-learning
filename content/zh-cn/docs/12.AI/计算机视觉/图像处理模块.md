...
> 参考：
> - [官方文档，模块-图像处理-物体检测](https://docs.opencv.org/4.x/df/dfb/group__imgproc__object.html)
> - [官方文档，教程-图像处理-模板匹配](https://docs.opencv.org/4.x/de/da9/tutorial_template_matching.html)

通过[模板匹配](https://docs.opencv.org/4.x/de/da9/tutorial_template_matching.html)技术查找与模板图像（补丁）匹配（相似）的**图像区域**的技术。
