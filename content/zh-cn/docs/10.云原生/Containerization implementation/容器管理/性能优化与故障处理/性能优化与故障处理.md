...
# 容器内网络设备信息
[root@desistdaydream network-scripts]# nsenter -n -t 3039
[root@desistdaydream network-scripts]# ip a
....
...
```shell
[root@desistdaydream mounts]# pwd
/var/lib/docker/image/overlay2/layerdb/mounts
[root@desistdaydream mounts]# grep -r d976eddf7575a3464486d92539229146f3df66080a3265195791ebb0d24b24dd ./
...
```shell
[root@desistdaydream layerdb]# docker ps --all | grep 28f5bed704
