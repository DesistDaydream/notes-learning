...
Volume 功能详解见 [Volume](/docs/10.云原生/2.3.Kubernetes%20容器编排系统/9.Kubernetes%20存储/Volume/Volume.md) 章节
...
详见 [CSI](/docs/10.云原生/2.3.Kubernetes%20容器编排系统/9.Kubernetes%20存储/CSI/CSI.md)
