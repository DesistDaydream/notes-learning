...
```bash
rabbitmq-stack-allinone]# kubectl get pod -n sc-provisioner
...
```bash
rabbitmq-stack-allinone]# kubectl get storageclasses.storage.k8s.io managed-nfs-storage -o yaml | neat
...
```bash
rabbitmq-stack-allinone]# kubectl get pvc -n rabbitmq
...
rabbitmq-stack-allinone]# kubectl get pv
